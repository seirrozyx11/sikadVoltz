...
import contactRoutes from './routes/contactRoutes.js'; // Contact form and feedback
...
app.use('/api/contact', deprecationWarning, contactRoutes); // Contact form and feedback
